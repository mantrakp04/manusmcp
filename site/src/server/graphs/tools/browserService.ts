...
// Singleton for browser management
class BrowserManager {
  ...
  getConsoleLog(maxLines?: number): string[] {
    if (!maxLines) return [...this.consoleLog];
    return this.consoleLog.slice(-maxLines);
  }
  ...
  async captureAndParseScreenshot(): Promise<{
    screenshot: Buffer,
...
// Browser view tool
export const browserViewTool = new DynamicStructuredTool({
  name: "browser_view",
  ...
  func: async () => {
    try {
      ...
      const { screenshot, parsedScreenshot, parsedText } = await manager.captureAndParseScreenshot();
      return [
        {
          type: "image",
...
export const browserRestartTool = new DynamicStructuredTool({
...
// Browser click tool
export const browserClickTool = new DynamicStructuredTool({
  name: "browser_click",
...
// Browser input tool
export const browserInputTool = new DynamicStructuredTool({
  name: "browser_input",
...
export const browserMoveMouseTool = new DynamicStructuredTool({
...
export const browserPressKeyTool = new DynamicStructuredTool({
...
export const browserSelectOptionTool = new DynamicStructuredTool({
...
export const browserScrollUpTool = new DynamicStructuredTool({
...
export const browserScrollDownTool = new DynamicStructuredTool({
...
export const browserConsoleExecTool = new DynamicStructuredTool({
...
export const browserConsoleViewTool = new DynamicStructuredTool({
  ...
  func: async ({ max_lines }) => {
    try {
      const manager = BrowserManager.getInstance();
      const log = manager.getConsoleLog(max_lines);
